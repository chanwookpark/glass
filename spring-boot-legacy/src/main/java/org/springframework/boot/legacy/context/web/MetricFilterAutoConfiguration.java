...
/**
 * {@link org.springframework.boot.autoconfigure.EnableAutoConfiguration Auto-configuration} that records Servlet interactions
 * with a {@link org.springframework.boot.actuate.metrics.CounterService} and {@link org.springframework.boot.actuate.metrics.GaugeService}.
 * 
 * @author Dave Syer
 * @author Phillip Webb
 */
	...
	private final class MetricsFilter extends OncePerRequestFilter {
		...
		protected void doFilterInternal(HttpServletRequest request,
			...
			try {
				...
				org.springframework.boot.legacy.context.web.MetricFilterAutoConfiguration.this.gaugeService.submit(gaugeKey,
						stopWatch.getTotalTimeMillis());
				String counterKey = getKey("status." + getStatus(wrapper) + suffix);
				org.springframework.boot.legacy.context.web.MetricFilterAutoConfiguration.this.counterService.increment(counterKey);
			}
		}

...
/**
 * A version of the {@link org.springframework.boot.context.embedded.EmbeddedWebApplicationContext} that can be used with a
...
public class NonEmbeddedWebApplicationContext extends GenericWebApplicationContext {
	...
	/**
	 * Prepare the {@link org.springframework.web.context.WebApplicationContext} with the given fully loaded
	 * {@link javax.servlet.ServletContext}. This method is usually called from
	 * {@link org.springframework.boot.context.embedded.ServletContextInitializer#onStartup(javax.servlet.ServletContext)} and is similar to the
	 * functionality usually provided by a {@link org.springframework.web.context.ContextLoaderListener}.
